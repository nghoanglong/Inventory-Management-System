...
public class ORDER {
    ...
    public ORDER(String id_ord, String name_cus, String fullname_user, String type_ord, String date_ord, int state_ord){
        ...
        if(state_ord == 2) {
            this.state_ord = "PENDING";
        }else if(state_ord == 1){
            this.state_ord = "ACCEPT";
        }else{
            this.state_ord = "DENY";
        }
    }
    ...
    public String getState_ord(){return this.state_ord;}
    ...
    public void setState_ord(int state_ord){
        if(state_ord == 2) {
            this.state_ord = "PENDING";
        }else if(state_ord == 1){
            this.state_ord = "ACCEPT";
