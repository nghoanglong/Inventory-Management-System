...
public class CONNECT_QLSP_TABLE extends CONNECT_DB{

    public CONNECT_QLSP_TABLE(String user_name, String pwd, String ServerName, int PortNumber, String DatabaseName){
    ...
    public static void main(String[] args){
        CONNECT_QLSP_TABLE new_connect = new CONNECT_QLSP_TABLE("sa",
                "1712",
