...
public class CONNECT_QLYC_TABLE extends CONNECT_DB{

    public CONNECT_QLYC_TABLE(String user_name, String pwd, String ServerName, int PortNumber, String DatabaseName){
    ...
    public static void main(String[] args){
        CONNECT_QLYC_TABLE new_connect = new CONNECT_QLYC_TABLE("sa",
                "1712",
