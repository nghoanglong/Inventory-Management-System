...
public class CONNECT_USER_TABLE extends CONNECT_DB{

    public CONNECT_USER_TABLE(String user_name, String pwd, String ServerName, int PortNumber, String DatabaseName){
    ...
    public static void main(String[] args){
        CONNECT_USER_TABLE new_connect = new CONNECT_USER_TABLE("sa",
                "1712",
