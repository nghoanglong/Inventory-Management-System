...
-- ACCOUNT
INSERT INTO ACCOUNT VALUES('ACCOUNT01', (SELECT id_user FROM USERS WHERE id_user = 'USER01'), 'hoanglong', 'baeba0a7209c391842bb02d1a722c2c8', 1);
...
INSERT INTO MNG_ORDERS VALUES('MNG_ORDERS01', (SELECT id_user FROM USERS WHERE id_user = 'USER01'), (SELECT id_cus FROM CUSTOMER_INFO WHERE id_cus = 'CUSTOMER01'), 'EXPORT', '2021-06-25', 1);
INSERT INTO MNG_ORDERS VALUES('MNG_ORDERS02', (SELECT id_user FROM USERS WHERE id_user = 'USERS-499472378'), (SELECT id_cus FROM CUSTOMER_INFO WHERE id_cus = 'CUSTOMER03'), 'EXPORT', '2021-05-25', 1);
INSERT INTO MNG_ORDERS VALUES('MNG_ORDERS03', (SELECT id_user FROM USERS WHERE id_user = 'USERS1452363000'), (SELECT id_cus FROM CUSTOMER_INFO WHERE id_cus = 'CUSTOMER02'), 'EXPORT', '2021-04-25', 1);
INSERT INTO MNG_ORDERS VALUES('MNG_ORDERS04', (SELECT id_user FROM USERS WHERE id_user = 'USER01'), (SELECT id_cus FROM CUSTOMER_INFO WHERE id_cus = 'CUSTOMER04'), 'EXPORT', '2021-02-25', 1);
INSERT INTO MNG_ORDERS VALUES('MNG_ORDERS05', (SELECT id_user FROM USERS WHERE id_user = 'USERS1452363000'), (SELECT id_cus FROM CUSTOMER_INFO WHERE id_cus = 'CUSTOMER05'), 'EXPORT', '2021-01-25', 1);
